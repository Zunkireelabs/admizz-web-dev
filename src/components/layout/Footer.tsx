...
const socialLinks = [
  {
    name: "Facebook",
    href: "https://www.facebook.com/admizz",
    icon: (
  ...
  {
    name: "Twitter",
    href: "https://twitter.com/admizz_official",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "YouTube",
    href: "https://youtube.com/c/Admizz_official",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "TikTok",
    href: "https://www.tiktok.com/@admizz_official",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
