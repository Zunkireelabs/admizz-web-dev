 ...
 * Appears after the user scrolls past the hero. Two actions:
...
export default function IndiaStickyMobileCTA({
  ...
  return (
    <div
      ...
      style={{
        background: "linear-gradient(180deg, transparent, rgba(255,248,241,0.95) 30%, #FFF8F1 100%)",
    ...
    >
      <div
        className="flex items-stretch gap-2 rounded-2xl p-2"
        style={{
          background: "#fff",
          border: "1px solid rgba(201,169,97,0.4)",
          boxShadow: "0 8px 30px rgba(11,61,46,0.18)",
        }}
      >
        <a
          href={registerHref}
          ...
          style={{
            background: "linear-gradient(135deg, #FF6B1A, #C9472A)",
            color: "#fff",
        ...
        <a
          ...
          aria-label="WhatsApp"
          className="inline-flex items-center justify-center w-14 rounded-xl"
          style={{
            background: "#25D366",
            color: "#fff",
          }}
