...
export default function UKStickyMobileCTA({
  ...
  return (
    <div
      ...
      style={{
        background: "linear-gradient(180deg, transparent, rgba(245,243,238,0.95) 30%, #F5F3EE 100%)",
    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: "0 8px 30px rgba(0,33,71,0.18)",
        }}
      >
        <a
          href={registerHref}
          ...
          style={{
            background: "linear-gradient(135deg, #002147, #001633)",
            color: "#fff",
