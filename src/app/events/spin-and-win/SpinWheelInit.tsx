...
const UNIVERSITIES: Record<string, { name: string; logo: string }[]> = {
  ...
  Denmark: [
    { name: 'University of Copenhagen', logo: 'https://admizzeducation.com/images/universities/denmark/university-of-copenhagen.png' },
    { name: 'Aarhus University', logo: 'https://admizzeducation.com/images/universities/denmark/aarhus-university.png' },
    { name: 'DTU', logo: 'https://admizzeducation.com/images/universities/denmark/technical-university-of-denmark.png' },
    { name: 'CBS', logo: 'https://admizzeducation.com/images/universities/denmark/copenhagen-business-school.png' },
  ],
  UAE: [
    { name: 'UAEU', logo: 'https://admizzeducation.com/images/universities/uae/uaeu.png' },
    { name: 'Khalifa University', logo: 'https://admizzeducation.com/images/universities/uae/khalifa-university.jpg' },
    { name: 'AUS', logo: 'https://admizzeducation.com/images/universities/uae/american-university-of-sharjah.jpg' },
    { name: 'Zayed University', logo: 'https://admizzeducation.com/images/universities/uae/zayed-university.png' },
    { name: 'AUD', logo: 'https://admizzeducation.com/images/universities/uae/american-university-in-dubai.png' },
  ],
  France: [
...
export default function SpinWheelInit() {
  useEffect(() => {
    // Expose form option data for spin-wheel-prod.js
    (window as any).SD_COUNTRIES = [{ code: 'NP', dial: '+977', name: 'Nepal', def: true }];
    (window as any).SD_DESTINATIONS = ['USA', 'UK', 'Australia', 'Canada', 'New Zealand', 'India', 'France', 'Denmark', 'UAE', 'Germany', 'Finland'];
    (window as any).SD_LEVELS = ['Certificate', 'Diploma', 'Bachelors', 'Masters', 'PhD'];
    (window as any).SD_PROGRAMS = ['Engineering & Technology', 'Allied Health Sciences', 'Humanities & Social Sciences', 'Business & Management', 'Law & Legal Studies', 'Architecture & Design', 'Applied Sciences', 'Medical & Pharmacy'];

    // Initialise partners marquee
    renderPartners('UK');
    ...
    // Dynamically inject spin-wheel-prod.js — DOM is guaranteed ready inside useEffect
    const script = document.createElement('script');
    script.src = '/events/js/spin-wheel-prod.js';
    script.async = true;
