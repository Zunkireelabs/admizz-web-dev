...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://admizzeducation.com/events/uk-education-expo-oct-2026",
  },
  openGraph: {
    title: "UK Education Expo 2026 (October) | Admizz Education",
    description:
      "Your Direct Pathway to Top Modern UK Universities. On-the-spot assessment, scholarship guidance, credential evaluation & PSW briefing.",
    url: "https://admizzeducation.com/events/uk-education-expo-oct-2026",
          ...
          <div className="uk-intake-card">
            ...
            <div className="uk-intake-grid">
              <div className="uk-intake-col">
                ...
                <h4 className="uk-intake-name">Nov/Dec 2026</h4>
              ...
              <div className="uk-intake-col">
                ...
                <h4 className="uk-intake-name">May 2027</h4>
                <p className="uk-intake-rec">
      ...
      <div className="register-panel" id="registerPanel">
        ...
        <div className="register-panel-body">
          ...
          >
            ...
            <input type="hidden" name="Src" value="AdmizzEdu-UK-Education-Expo-Oct2026" />
