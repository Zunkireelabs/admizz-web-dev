...
{/* SEOAI:FAQ:START */}<div suppressHydrationWarning dangerouslySetInnerHTML={{ __html: "<script type=\"application/ld+json\">{\"@type\":\"FAQPage\",\"@context\":\"https://schema.org\",\"mainEntity\":[{\"name\":\"What types of scholarships are available for Nepali students to study in India?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"There are various scholarship programs available for Nepali students, including the Army Public School Scholarship Scheme for school-level students, the Atal Bihari Vajpayee General Scholarship Scheme for non-medical bachelor programs, the COMPEX Scholarship Scheme for engineering and agriculture degrees, and the AYUSH Scholarship Scheme for traditional Indian medicine, among others.\",\"@type\":\"Answer\"}},{\"name\":\"How many scholarships does the Government of India offer to Nepali students each year?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"The Government of India offers around 1,500 scholarships to Nepali nationals each year.\",\"@type\":\"Answer\"}},{\"name\":\"Since when has the scholarship program been supporting Nepali students?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"The scholarship programs have been supporting Nepali students since 2006.\",\"@type\":\"Answer\"}},{\"name\":\"What levels of education can Nepali students pursue with these scholarships?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Nepali students can pursue a wide range of educational levels, including middle school, undergraduate, postgraduate, and Ph.D. levels with these scholarships.\",\"@type\":\"Answer\"}},{\"name\":\"Are the scholarships only for students studying in India?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"No, the scholarships benefit students studying both in India and within Nepal.\",\"@type\":\"Answer\"}},{\"name\":\"What is the purpose of these scholarship programs?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"The scholarship programs aim to foster capacity building and empower Nepal's youth through quality education and financial support.\",\"@type\":\"Answer\"}}]}</script>" }} />{/* SEOAI:FAQ:END */}
</main>
  );
}
