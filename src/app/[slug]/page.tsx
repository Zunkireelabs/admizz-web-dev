...
{/* SEOAI:FAQ:START */}<div suppressHydrationWarning dangerouslySetInnerHTML={{ __html: "<script type=\"application/ld+json\">{\"@type\":\"FAQPage\",\"@context\":\"https://schema.org\",\"mainEntity\":[{\"name\":\"What are the eligibility requirements for Nepali students to study in the UK after +2?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Nepali students can apply directly to UK undergraduate programs after completing +2 (NEB or equivalent) with a minimum of 50–60% marks.\",\"@type\":\"Answer\"}},{\"name\":\"What is the average tuition cost for international undergraduate students in the UK?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Annual tuition for international students ranges from GBP 12,000 to GBP 25,000.\",\"@type\":\"Answer\"}},{\"name\":\"Is part-time work allowed for Nepali students while studying in the UK?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Yes, Nepali students are allowed to work part-time for up to 20 hours per week during term.\",\"@type\":\"Answer\"}},{\"name\":\"What is the Graduate Route visa and how does it benefit international students?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"The Graduate Route visa allows international students to remain in the UK for two years after graduation to work, look for jobs, or start a business.\",\"@type\":\"Answer\"}},{\"name\":\"Do UK universities require IELTS for admission?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Most universities require an IELTS Academic score of 6.0–6.5 overall, with no band below 5.5.\",\"@type\":\"Answer\"}},{\"name\":\"What scholarships are available for Nepali students wishing to study in the UK?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"The Chevening Scholarship and Commonwealth Scholarships offer fully funded opportunities, primarily for postgraduate study.\",\"@type\":\"Answer\"}}]}</script>" }} />{/* SEOAI:FAQ:END */}
</main>
  );
}
