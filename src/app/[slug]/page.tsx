...
{/* SEOAI:FAQ:START */}<div suppressHydrationWarning dangerouslySetInnerHTML={{ __html: "<script type=\"application/ld+json\">{\"@type\":\"FAQPage\",\"@context\":\"https://schema.org\",\"mainEntity\":[{\"name\":\"What are some of the top government colleges in India?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Some of the top government colleges in India include the Indian Institute of Technology (IIT) Bombay, Indian Institute of Technology (IIT) Delhi, All India Institute of Medical Sciences (AIIMS) New Delhi, Indian Institute of Management (IIM) Ahmedabad, National Law School of India University (NLSIU) Bangalore, Jawaharlal Nehru University (JNU), and University of Delhi (DU).\",\"@type\":\"Answer\"}},{\"name\":\"How can I apply to IIT Bombay?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"To apply to IIT Bombay, students must take the JEE Main and JEE Advanced exams for undergraduate programs and the GATE exam for postgraduate programs.\",\"@type\":\"Answer\"}},{\"name\":\"What programs does AIIMS New Delhi offer?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"AIIMS New Delhi offers programs such as MBBS, MD/MS, Super Specialty Courses, and Ph.D.\",\"@type\":\"Answer\"}},{\"name\":\"What is the admission process for IIM Ahmedabad?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"The admission process for IIM Ahmedabad requires students to take the CAT (Common Admission Test) for the MBA program.\",\"@type\":\"Answer\"}},{\"name\":\"Why is NLSIU considered a top choice for law students?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"NLSIU is considered a top choice for law students due to its excellent legal education and research facilities.\",\"@type\":\"Answer\"}}]}</script>" }} />{/* SEOAI:FAQ:END */}
</main>
  );
}
