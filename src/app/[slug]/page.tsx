...
{/* SEOAI:FAQ:START */}<div suppressHydrationWarning dangerouslySetInnerHTML={{ __html: "<script type=\"application/ld+json\">{\"@type\":\"FAQPage\",\"@context\":\"https://schema.org\",\"mainEntity\":[{\"name\":\"What is the Fulbright Foreign Student Program?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"The Fulbright Foreign Student Program (FFSP) is the United States government's flagship international educational and cultural exchange initiative, administered globally by the Institute of International Education (IIE) and in Nepal by the U.S. Educational Foundation in Nepal (USEF-Nepal). It funds a fully-paid Master's degree at selected US universities for Nepali students.\",\"@type\":\"Answer\"}},{\"name\":\"What are the benefits of the Fulbright Scholarship?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"The Fulbright FFSP is a comprehensive, fully-funded scholarship that covers full tuition at a selected US university, a monthly living stipend, round-trip travel from Nepal to the US, comprehensive health insurance, visa sponsorship for the grantee and eligible dependents, pre-academic training, post-degree opportunities, and induction into the global Fulbright alumni network.\",\"@type\":\"Answer\"}},{\"name\":\"What are the eligibility requirements for Nepali applicants?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"To be considered for the Fulbright FFSP from Nepal, applicants must hold valid Nepali citizenship and be a current resident of Nepal at the time of applying. They must also meet specific work experience criteria.\",\"@type\":\"Answer\"}},{\"name\":\"How many scholarships are awarded each year through the Fulbright Program?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Approximately 4,000 scholarships are awarded globally each year, with around 4 nominees selected from Nepal annually.\",\"@type\":\"Answer\"}},{\"name\":\"What is the J-1 Visa Two-Year Rule?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"All Fulbright grantees receive a J-1 exchange visitor visa, which requires them to return to Nepal upon completing their academic program. Grantees must complete two years of home residency in Nepal before they are eligible for a US immigrant visa, permanent residence, or certain non-immigrant work visas.\",\"@type\":\"Answer\"}},{\"name\":\"When will selected participants begin their studies?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Selected participants for the 2027-28 cycle of the Fulbright Program will begin their studies in Fall 2027.\",\"@type\":\"Answer\"}}]}</script>" }} />{/* SEOAI:FAQ:END */}
</main>
  );
}
