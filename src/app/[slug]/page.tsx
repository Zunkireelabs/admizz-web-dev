...
{/* SEOAI:FAQ:START */}<div suppressHydrationWarning dangerouslySetInnerHTML={{ __html: "<dl class=\"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8\">\n  <dt class=\"text-[28px] sm:text-[36px] md:text-[50px] font-bold leading-[1.15] sm:leading-[1.1] mb-4 sm:mb-6\">What is the COMPEX Scholarship?</dt>\n  <dd class=\"mt-3 text-sm opacity-80 gap-2.5\">The COMPEX (Common Educational Scholarship) is a merit-based initiative that provides financial support to eligible Nepali students who wish to pursue specific undergraduate courses in India. These courses are offered by some of the most reputed Indian institutions recognized by the Indian government.</dd>\n  <dt class=\"text-[28px] sm:text-[36px] md:text-[50px] font-bold leading-[1.15] sm:leading-[1.1] mb-4 sm:mb-6\">What are the eligibility criteria for the COMPEX Scholarship?</dt>\n  <dd class=\"mt-3 text-sm opacity-80 gap-2.5\">To be eligible for the COMPEX Scholarship, applicants must be between 16 to 23 years old as of July 1 of the current year and must have passed Class XII (10+2) with specific academic requirements depending on the program they are applying for.</dd>\n  <dt class=\"text-[28px] sm:text-[36px] md:text-[50px] font-bold leading-[1.15] sm:leading-[1.1] mb-4 sm:mb-6\">What undergraduate courses can be pursued through the COMPEX Scholarship?</dt>\n  <dd class=\"mt-3 text-sm opacity-80 gap-2.5\">Nepali students can apply for the following undergraduate courses: BE/B.Tech (Engineering), B.Sc. Agriculture, B. Pharmacy, B.Sc. Food Technology, and B.Sc. Nursing.</dd>\n  <dt class=\"text-[28px] sm:text-[36px] md:text-[50px] font-bold leading-[1.15] sm:leading-[1.1] mb-4 sm:mb-6\">How can I apply for the COMPEX Scholarship?</dt>\n  <dd class=\"mt-3 text-sm opacity-80 gap-2.5\">Applications must be submitted via the official online link provided by the Embassy of India at the time of announcement. It is important to read all instructions carefully before filling the form as changes cannot be made after submission.</dd>\n  <dt class=\"text-[28px] sm:text-[36px] md:text-[50px] font-bold leading-[1.15] sm:leading-[1.1] mb-4 sm:mb-6\">What documents are required for the COMPEX Scholarship application?</dt>\n  <dd class=\"mt-3 text-sm opacity-80 gap-2.5\">Applicants need to upload several documents while submitting their online application, including a Class XII Mark Sheet, a Character Certificate, a Citizenship Certificate with English translation, relevant pages of their Passport, an SBI Bank Voucher for NPR 400, and any other specified documents.</dd>\n  <dt class=\"text-[28px] sm:text-[36px] md:text-[50px] font-bold leading-[1.15] sm:leading-[1.1] mb-4 sm:mb-6\">Is there a written test involved in the selection process for the COMPEX Scholarship?</dt>\n  <dd class=\"mt-3 text-sm opacity-80 gap-2.5\">Yes, all eligible applicants will be invited to take a written exam/test as part of the selection process.</dd>\n</dl>\n<script type=\"application/ld+json\">{\"@type\":\"FAQPage\",\"@context\":\"https://schema.org\",\"mainEntity\":[{\"name\":\"What is the COMPEX Scholarship?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"The COMPEX (Common Educational Scholarship) is a merit-based initiative that provides financial support to eligible Nepali students who wish to pursue specific undergraduate courses in India. These courses are offered by some of the most reputed Indian institutions recognized by the Indian government.\",\"@type\":\"Answer\"}},{\"name\":\"What are the eligibility criteria for the COMPEX Scholarship?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"To be eligible for the COMPEX Scholarship, applicants must be between 16 to 23 years old as of July 1 of the current year and must have passed Class XII (10+2) with specific academic requirements depending on the program they are applying for.\",\"@type\":\"Answer\"}},{\"name\":\"What undergraduate courses can be pursued through the COMPEX Scholarship?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Nepali students can apply for the following undergraduate courses: BE/B.Tech (Engineering), B.Sc. Agriculture, B. Pharmacy, B.Sc. Food Technology, and B.Sc. Nursing.\",\"@type\":\"Answer\"}},{\"name\":\"How can I apply for the COMPEX Scholarship?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Applications must be submitted via the official online link provided by the Embassy of India at the time of announcement. It is important to read all instructions carefully before filling the form as changes cannot be made after submission.\",\"@type\":\"Answer\"}},{\"name\":\"What documents are required for the COMPEX Scholarship application?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Applicants need to upload several documents while submitting their online application, including a Class XII Mark Sheet, a Character Certificate, a Citizenship Certificate with English translation, relevant pages of their Passport, an SBI Bank Voucher for NPR 400, and any other specified documents.\",\"@type\":\"Answer\"}},{\"name\":\"Is there a written test involved in the selection process for the COMPEX Scholarship?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Yes, all eligible applicants will be invited to take a written exam/test as part of the selection process.\",\"@type\":\"Answer\"}}]}</script>" }} />{/* SEOAI:FAQ:END */}
</main>
  );
}
