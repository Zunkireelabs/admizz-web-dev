...
{/* SEOAI:FAQ:START */}<div suppressHydrationWarning dangerouslySetInnerHTML={{ __html: "<script type=\"application/ld+json\">{\"@type\":\"FAQPage\",\"@context\":\"https://schema.org\",\"mainEntity\":[{\"name\":\"What types of engineering courses are offered at KIIT University?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"KIIT University offers a wide range of engineering disciplines, including Computer Science, Mechanical Engineering, Civil Engineering, and Electrical Engineering, as part of its Bachelor of Technology (B.Tech) program.\",\"@type\":\"Answer\"}},{\"name\":\"Is there a nursing program available at KIIT University?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Yes, KIIT University offers a Bachelor of Science in Nursing (B.Sc Nursing) program that focuses on developing clinical proficiency, critical thinking, and compassionate care.\",\"@type\":\"Answer\"}},{\"name\":\"What is the focus of the Bachelor of Business Administration (BBA) program at KIIT?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"The BBA program at KIIT focuses on building managerial skills, strategic thinking, and an understanding of global business practices, covering areas such as finance, marketing, human resources, and operations.\",\"@type\":\"Answer\"}},{\"name\":\"Does KIIT University offer courses related to media and entertainment?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Yes, KIIT University offers a Bachelor’s program in Film and Television Production, which covers various aspects of filmmaking including direction, cinematography, editing, and screenwriting.\",\"@type\":\"Answer\"}},{\"name\":\"How does KIIT University emphasize practical learning in its programs?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"KIIT University emphasizes practical learning through internships, industry projects, and interactive sessions with industry experts across its programs.\",\"@type\":\"Answer\"}}]}</script>" }} />{/* SEOAI:FAQ:END */}
</main>
  );
}
