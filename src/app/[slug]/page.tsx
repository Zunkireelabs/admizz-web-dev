...
{/* SEOAI:FAQ:START */}<div suppressHydrationWarning dangerouslySetInnerHTML={{ __html: "<script type=\"application/ld+json\">{\"@type\":\"FAQPage\",\"@context\":\"https://schema.org\",\"mainEntity\":[{\"name\":\"What engineering courses are offered at KIIT University?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"KIIT University offers a wide range of engineering disciplines within its Bachelor of Technology (B.Tech) program, including Computer Science, Mechanical Engineering, Civil Engineering, and Electrical Engineering, among others.\",\"@type\":\"Answer\"}},{\"name\":\"Is there a nursing program at KIIT University?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Yes, KIIT University offers a Bachelor of Science in Nursing (B.Sc Nursing) program designed for students interested in healthcare and patient care, focusing on clinical proficiency and compassionate care.\",\"@type\":\"Answer\"}},{\"name\":\"What does the Bachelor of Business Administration program at KIIT University focus on?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"The Bachelor of Business Administration (BBA) program at KIIT focuses on building managerial skills, strategic thinking, and understanding global business practices, covering areas such as finance, marketing, human resources, and operations.\",\"@type\":\"Answer\"}},{\"name\":\"Does KIIT University offer programs related to media and entertainment?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Yes, KIIT University offers a Bachelor’s program in Film and Television Production, which allows students to explore filmmaking aspects, including direction, cinematography, editing, and screenwriting.\",\"@type\":\"Answer\"}},{\"name\":\"What is the emphasis of the courses offered at KIIT University?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"The courses offered at KIIT University emphasize innovation, research, and industry collaboration, aiming to prepare students for a dynamic future in their respective fields.\",\"@type\":\"Answer\"}}]}</script>" }} />{/* SEOAI:FAQ:END */}
</main>
  );
}
