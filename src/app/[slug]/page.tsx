...
{/* SEOAI:FAQ:START */}<div suppressHydrationWarning dangerouslySetInnerHTML={{ __html: "<script type=\"application/ld+json\">{\"@type\":\"FAQPage\",\"@context\":\"https://schema.org\",\"mainEntity\":[{\"name\":\"Can Nepali students study in the UK after completing +2?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Yes, Nepali students who have completed their +2 from NEB or an equivalent A-Level program are eligible to apply for UK undergraduate programs.\",\"@type\":\"Answer\"}},{\"name\":\"What are the English language requirements for studying in the UK?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Most universities require an IELTS Academic score of 6.0–6.5 overall, with no band below 5.5.\",\"@type\":\"Answer\"}},{\"name\":\"What is the average tuition fee for international students in the UK?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Annual tuition for international students ranges from GBP 12,000 to GBP 25,000.\",\"@type\":\"Answer\"}},{\"name\":\"Are there scholarships available for Nepali students studying in the UK?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Yes, the Chevening Scholarship and Commonwealth Scholarships offer fully funded opportunities, primarily for postgraduate study.\",\"@type\":\"Answer\"}},{\"name\":\"What is the Graduate Route visa?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"The Graduate Route visa allows international students to remain in the UK for two years after graduation (three years for PhD graduates) to work, look for jobs, or start a business.\",\"@type\":\"Answer\"}},{\"name\":\"What are the living costs for students in the UK?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Living costs add GBP 900–1,400 per month.\",\"@type\":\"Answer\"}}]}</script>" }} />{/* SEOAI:FAQ:END */}
</main>
  );
}
