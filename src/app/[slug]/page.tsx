...
{/* SEOAI:FAQ:START */}<div suppressHydrationWarning dangerouslySetInnerHTML={{ __html: "<script type=\"application/ld+json\">{\"@type\":\"FAQPage\",\"@context\":\"https://schema.org\",\"mainEntity\":[{\"name\":\"What is the first step in the UK student visa process for Nepalese students?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"The first step is to receive an offer letter from a recognized UK university. Once accepted, you will get a Confirmation of Acceptance for Studies (CAS), which is crucial for your visa application.\",\"@type\":\"Answer\"}},{\"name\":\"What documents do I need to prepare for the UK student visa application?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"You will typically need a valid passport, CAS letter from the university, proof of financial ability (like bank statements or sponsor letters), academic transcripts and certificates, English language test results, a Tuberculosis (TB) test certificate, and recent passport-size photographs.\",\"@type\":\"Answer\"}},{\"name\":\"How do I prove my financial requirements for the UK student visa?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"You must demonstrate that you can cover tuition fees and living expenses. For tuition fees, refer to the amount listed in your CAS. For living costs, you need to show at least £1,334 per month for London and £1,023 per month for other cities, for up to 9 months. The funds must be held in your account (or your sponsor’s) for at least 28 consecutive days before applying.\",\"@type\":\"Answer\"}},{\"name\":\"What is the application fee for the UK student visa?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"The visa application fee is around £490, and you will also need to pay the Immigration Health Surcharge (IHS) for access to UK healthcare.\",\"@type\":\"Answer\"}},{\"name\":\"What happens after I submit my online visa application?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"After submitting your application, you must book a biometrics appointment at the Visa Application Centre in Kathmandu, where officials will take your fingerprints and photograph.\",\"@type\":\"Answer\"}},{\"name\":\"What should I do if I miss a document in my visa application?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Missing documents can cause delays, so it’s important to double-check everything before submission to ensure a smooth visa process.\",\"@type\":\"Answer\"}}]}</script>" }} />{/* SEOAI:FAQ:END */}
</main>
  );
}
