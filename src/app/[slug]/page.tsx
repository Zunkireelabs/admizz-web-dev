...
{/* SEOAI:FAQ:START */}<div suppressHydrationWarning dangerouslySetInnerHTML={{ __html: "<script type=\"application/ld+json\">{\"@type\":\"FAQPage\",\"@context\":\"https://schema.org\",\"mainEntity\":[{\"name\":\"What is an NOC and why is it needed for studying abroad?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"An NOC, or No Objection Certificate, is an official document issued by Nepal's Ministry of Education, Science and Technology (MoEST). It serves as a formal declaration that the Nepali government has no objection to you pursuing education abroad. The NOC is essential for financial transfers from Nepali banks for tuition and living expenses, and it can also serve as a supporting document in visa applications.\",\"@type\":\"Answer\"}},{\"name\":\"How can I apply for an NOC from Nepal?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"You can apply for an NOC online at noc.moest.gov.np after receiving an unconditional offer letter from a foreign university. Make sure to submit all required documents correctly to avoid delays.\",\"@type\":\"Answer\"}},{\"name\":\"What is the application fee for obtaining an NOC?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"The application fee for obtaining an NOC is NPR 2,000, which can be paid online via eSewa or at Rastriya Banijya Bank.\",\"@type\":\"Answer\"}},{\"name\":\"How long does it take to process the NOC application?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"The processing of the NOC application typically takes 3 to 7 working days once all documents are correctly submitted.\",\"@type\":\"Answer\"}},{\"name\":\"What is the validity period of the NOC once issued?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"The NOC is valid for 6 months from the date of issue, so it’s advisable to apply only when your visa deadline is near.\",\"@type\":\"Answer\"}},{\"name\":\"Are there any restrictions on the types of courses for which an NOC can be issued?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Yes, currently only bachelor's level and above qualify for NOC issuance, and diploma and language courses are restricted.\",\"@type\":\"Answer\"}}]}</script>" }} />{/* SEOAI:FAQ:END */}
</main>
  );
}
