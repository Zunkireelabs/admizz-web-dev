...
{/* SEOAI:FAQ:START */}<div suppressHydrationWarning dangerouslySetInnerHTML={{ __html: "<script type=\"application/ld+json\">{\"@type\":\"FAQPage\",\"@context\":\"https://schema.org\",\"mainEntity\":[{\"name\":\"What is a No Objection Certificate (NOC)?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"An NOC, or No Objection Certificate, is an official document issued by Nepal's Ministry of Education, Science and Technology (MoEST) affirming that the Nepali government has no objection to you pursuing education abroad at a specific institution, in a specific country, for a specific course.\",\"@type\":\"Answer\"}},{\"name\":\"Why do I need an NOC to study abroad?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"The NOC is essential for two main reasons: it is required by Nepali banks before they can process any international tuition fee payments or living expense remittances, and it is considered a supporting document for student visa applications in many countries.\",\"@type\":\"Answer\"}},{\"name\":\"How do I apply for an NOC?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"You can apply for an NOC online at noc.moest.gov.np after receiving an unconditional offer letter from a foreign university. You will need to pay an application fee of NPR 2,000.\",\"@type\":\"Answer\"}},{\"name\":\"How long does it take to receive the NOC?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Once all documents are correctly submitted, processing for the NOC typically takes between 3 to 7 working days.\",\"@type\":\"Answer\"}},{\"name\":\"How long is the NOC valid for?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"The NOC is valid for 6 months from the date of issue.\",\"@type\":\"Answer\"}},{\"name\":\"Are there any restrictions on who can apply for an NOC?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Currently, only students pursuing bachelor's level courses and above qualify for NOC issuance; diploma and language courses are restricted.\",\"@type\":\"Answer\"}}]}</script>" }} />{/* SEOAI:FAQ:END */}
</main>
  );
}
