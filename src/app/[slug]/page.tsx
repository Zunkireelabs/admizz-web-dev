...
{/* SEOAI:FAQ:START */}<div suppressHydrationWarning dangerouslySetInnerHTML={{ __html: "<dl class=\"px-4 sm:px-6 lg:px-8\">\n  <dt class=\"text-[28px] sm:text-[36px] md:text-[50px] font-bold leading-[1.15] sm:leading-[1.1] mb-4 sm:mb-6\">What is the COMPEX Scholarship?</dt>\n  <dd class=\"mt-3 text-sm opacity-80 gap-2.5\">The COMPEX (Common Educational Scholarship) is a merit-based initiative that provides financial support to eligible Nepali students who wish to pursue specific undergraduate courses in India. These courses are offered by some of the most reputed Indian institutions, including NITs, IIITs, and other universities recognized by the Indian government.</dd>\n  <dt class=\"text-[28px] sm:text-[36px] md:text-[50px] font-bold leading-[1.15] sm:leading-[1.1] mb-4 sm:mb-6\">What courses are available under the COMPEX Scholarship?</dt>\n  <dd class=\"mt-3 text-sm opacity-80 gap-2.5\">Nepali students can apply for the following undergraduate courses through the COMPEX Scheme: BE/B.Tech (Engineering), B.Sc. Agriculture, B. Pharmacy, B.Sc. Food Technology, and B.Sc. Nursing.</dd>\n  <dt class=\"text-[28px] sm:text-[36px] md:text-[50px] font-bold leading-[1.15] sm:leading-[1.1] mb-4 sm:mb-6\">What are the eligibility criteria for the COMPEX Scholarship?</dt>\n  <dd class=\"mt-3 text-sm opacity-80 gap-2.5\">To be eligible for the COMPEX Scholarship, applicants must be between 16 and 23 years old as of 1st July of the current year, have passed Class XII (10+2) with specific subject and minimum aggregate requirements, and must have the required documents ready for application submission.</dd>\n  <dt class=\"text-[28px] sm:text-[36px] md:text-[50px] font-bold leading-[1.15] sm:leading-[1.1] mb-4 sm:mb-6\">How do I apply for the COMPEX Scholarship?</dt>\n  <dd class=\"mt-3 text-sm opacity-80 gap-2.5\">Applications must be submitted through the official online portal announced by the Embassy during the launch of the scheme. It's important to read all instructions carefully and submit all documents as specified.</dd>\n  <dt class=\"text-[28px] sm:text-[36px] md:text-[50px] font-bold leading-[1.15] sm:leading-[1.1] mb-4 sm:mb-6\">What documents are required for the COMPEX Scholarship application?</dt>\n  <dd class=\"mt-3 text-sm opacity-80 gap-2.5\">Applicants must upload the following documents when submitting the online application: Class XII (+2) Mark Sheet, Character Certificate from the last attended school, Citizenship Certificate with English translation, relevant pages of Passport, SBI Bank Voucher for NPR 400 (non-refundable), and other specified documents.</dd>\n  <dt class=\"text-[28px] sm:text-[36px] md:text-[50px] font-bold leading-[1.15] sm:leading-[1.1] mb-4 sm:mb-6\">Is there a selection process for the COMPEX Scholarship?</dt>\n  <dd class=\"mt-3 text-sm opacity-80 gap-2.5\">Yes, all eligible applicants will be invited to take a written exam/test as part of the selection process, in addition to meeting the initial eligibility criteria.</dd>\n</dl>\n<script type=\"application/ld+json\">{\"@type\":\"FAQPage\",\"@context\":\"https://schema.org\",\"mainEntity\":[{\"name\":\"What is the COMPEX Scholarship?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"The COMPEX (Common Educational Scholarship) is a merit-based initiative that provides financial support to eligible Nepali students who wish to pursue specific undergraduate courses in India. These courses are offered by some of the most reputed Indian institutions, including NITs, IIITs, and other universities recognized by the Indian government.\",\"@type\":\"Answer\"}},{\"name\":\"What courses are available under the COMPEX Scholarship?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Nepali students can apply for the following undergraduate courses through the COMPEX Scheme: BE/B.Tech (Engineering), B.Sc. Agriculture, B. Pharmacy, B.Sc. Food Technology, and B.Sc. Nursing.\",\"@type\":\"Answer\"}},{\"name\":\"What are the eligibility criteria for the COMPEX Scholarship?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"To be eligible for the COMPEX Scholarship, applicants must be between 16 and 23 years old as of 1st July of the current year, have passed Class XII (10+2) with specific subject and minimum aggregate requirements, and must have the required documents ready for application submission.\",\"@type\":\"Answer\"}},{\"name\":\"How do I apply for the COMPEX Scholarship?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Applications must be submitted through the official online portal announced by the Embassy during the launch of the scheme. It's important to read all instructions carefully and submit all documents as specified.\",\"@type\":\"Answer\"}},{\"name\":\"What documents are required for the COMPEX Scholarship application?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Applicants must upload the following documents when submitting the online application: Class XII (+2) Mark Sheet, Character Certificate from the last attended school, Citizenship Certificate with English translation, relevant pages of Passport, SBI Bank Voucher for NPR 400 (non-refundable), and other specified documents.\",\"@type\":\"Answer\"}},{\"name\":\"Is there a selection process for the COMPEX Scholarship?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Yes, all eligible applicants will be invited to take a written exam/test as part of the selection process, in addition to meeting the initial eligibility criteria.\",\"@type\":\"Answer\"}}]}</script>" }} />{/* SEOAI:FAQ:END */}
</main>
  );
}
