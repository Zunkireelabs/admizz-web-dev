...
{/* SEOAI:FAQ:START */}<div suppressHydrationWarning dangerouslySetInnerHTML={{ __html: "<script type=\"application/ld+json\">{\"@type\":\"FAQPage\",\"@context\":\"https://schema.org\",\"mainEntity\":[{\"name\":\"What are the eligibility criteria for Nepali students to study in the UK after +2?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Nepali students can apply directly to UK undergraduate programs after completing +2 (NEB or equivalent) with a minimum of 50–60% marks.\",\"@type\":\"Answer\"}},{\"name\":\"What is the required IELTS score for admission to UK universities?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Most universities require an IELTS Academic score of 6.0–6.5 overall, with no band below 5.5.\",\"@type\":\"Answer\"}},{\"name\":\"What are the tuition fees for international students in the UK?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Annual tuition for international students ranges from GBP 12,000 to GBP 25,000, and living costs add GBP 900–1,400 per month.\",\"@type\":\"Answer\"}},{\"name\":\"What is the Graduate Route visa and how does it benefit international students?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"The Graduate Route visa allows students to work freely in the UK for two years after graduation (three years for PhD graduates) without needing a job offer.\",\"@type\":\"Answer\"}},{\"name\":\"What scholarship opportunities are available for Nepali students in the UK?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Nepali students can explore fully funded opportunities such as the Chevening Scholarship and Commonwealth Scholarships, primarily for postgraduate study.\",\"@type\":\"Answer\"}},{\"name\":\"Why is the UK an attractive study destination for Nepali students?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"The UK offers prestigious universities, shorter program durations, a multicultural environment, and strong industry connections, making it an excellent choice for ambitious students.\",\"@type\":\"Answer\"}}]}</script>" }} />{/* SEOAI:FAQ:END */}
</main>
  );
}
