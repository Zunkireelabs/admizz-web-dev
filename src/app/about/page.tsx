    ...
    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h1
                className="text-[28px] sm:text-[36px] md:text-[50px] font-bold leading-[1.1] mb-4 sm:mb-6"
                style={{ color: "#0D1282" }}
              >
                Empowering Students{" "}
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* 4 photo cards with pill background */}
          <div className="relative max-w-5xl mx-auto mt-4">
            {/* Pill / stadium-shaped background */}
            <div
              className="absolute -inset-x-8 top-1/2 -translate-y-1/2 mx-auto h-[80%] rounded-full"
              style={{ background: "#3D5BB8" }}
            />
            {/* Photos grid */}
            <div className="relative z-10 grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 px-2 sm:px-4">
              {[
                { src: "/images/about/2-1-763x1024.webp", alt: "Students getting guidance" },
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {[
              ...
              >
                ...
                <p className="text-[26px] sm:text-[34px] md:text-[42px] font-bold text-white mb-2 leading-none">
                  {stat.value}
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="grid md:grid-cols-[1.1fr_0.9fr] items-stretch">
              ...
              {/* Right — Founder Image */}
              <div className="relative bg-gradient-to-bl from-[#0D1282] to-[#1E6DEB] flex items-end justify-center min-h-[320px] md:min-h-[420px]">
                {/* Decorative circle */}
                <div
                  className="absolute top-[10%] left-[-20%] w-[280px] h-[280px] md:w-[340px] md:h-[340px] rounded-full opacity-20"
                ...
                <Image
                  ...
                  width={1024}
                  height={928}
                  className="relative z-10 w-full max-w-[280px] sm:max-w-[380px] h-auto object-contain"
                />
              </div>
            </div>
          </div>
...
{/* SEOAI:FAQ:START */}<div suppressHydrationWarning dangerouslySetInnerHTML={{ __html: "<dl class=\"px-4 sm:px-6 lg:px-8\">\n  <dt class=\"text-[28px] sm:text-[36px] md:text-[50px] font-bold leading-[1.15] sm:leading-[1.1] mb-4 sm:mb-6\">What services does Admizz provide for students looking to study abroad?</dt>\n  <dd class=\"mt-3 text-sm opacity-80 gap-2.5\">Admizz provides a range of services for international students, including test preparation, expert guidance, scholarship support, and a seamless application process to help secure admissions in institutions worldwide.</dd>\n  <dt class=\"text-[28px] sm:text-[36px] md:text-[50px] font-bold leading-[1.15] sm:leading-[1.1] mb-4 sm:mb-6\">How many universities and colleges are partnered with Admizz?</dt>\n  <dd class=\"mt-3 text-sm opacity-80 gap-2.5\">Admizz is partnered with over 100 prestigious institutions globally, providing students with a wide array of opportunities for higher education.</dd>\n  <dt class=\"text-[28px] sm:text-[36px] md:text-[50px] font-bold leading-[1.15] sm:leading-[1.1] mb-4 sm:mb-6\">What is the student visa approval rate for Admizz?</dt>\n  <dd class=\"mt-3 text-sm opacity-80 gap-2.5\">Admizz boasts a 95% student visa approval rate, reflecting the effectiveness of its support in the application process.</dd>\n  <dt class=\"text-[28px] sm:text-[36px] md:text-[50px] font-bold leading-[1.15] sm:leading-[1.1] mb-4 sm:mb-6\">What kind of scholarship support does Admizz offer?</dt>\n  <dd class=\"mt-3 text-sm opacity-80 gap-2.5\">Admizz has awarded over $2 million in scholarships to students, helping ease the financial burden of studying abroad.</dd>\n  <dt class=\"text-[28px] sm:text-[36px] md:text-[50px] font-bold leading-[1.15] sm:leading-[1.1] mb-4 sm:mb-6\">In which countries does Admizz help students secure admissions?</dt>\n  <dd class=\"mt-3 text-sm opacity-80 gap-2.5\">Admizz assists students in securing admissions in a variety of countries, including the USA, UK, Australia, Canada, India, New Zealand, Finland, Germany, and France.</dd>\n  <dt class=\"text-[28px] sm:text-[36px] md:text-[50px] font-bold leading-[1.15] sm:leading-[1.1] mb-4 sm:mb-6\">Who can benefit from Admizz's services?</dt>\n  <dd class=\"mt-3 text-sm opacity-80 gap-2.5\">Both international students seeking to study abroad and recruitment partners, such as education consultants, can benefit from Admizz's services.</dd>\n</dl>\n<script type=\"application/ld+json\">{\"@type\":\"FAQPage\",\"@context\":\"https://schema.org\",\"mainEntity\":[{\"name\":\"What services does Admizz provide for students looking to study abroad?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Admizz provides a range of services for international students, including test preparation, expert guidance, scholarship support, and a seamless application process to help secure admissions in institutions worldwide.\",\"@type\":\"Answer\"}},{\"name\":\"How many universities and colleges are partnered with Admizz?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Admizz is partnered with over 100 prestigious institutions globally, providing students with a wide array of opportunities for higher education.\",\"@type\":\"Answer\"}},{\"name\":\"What is the student visa approval rate for Admizz?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Admizz boasts a 95% student visa approval rate, reflecting the effectiveness of its support in the application process.\",\"@type\":\"Answer\"}},{\"name\":\"What kind of scholarship support does Admizz offer?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Admizz has awarded over $2 million in scholarships to students, helping ease the financial burden of studying abroad.\",\"@type\":\"Answer\"}},{\"name\":\"In which countries does Admizz help students secure admissions?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Admizz assists students in securing admissions in a variety of countries, including the USA, UK, Australia, Canada, India, New Zealand, Finland, Germany, and France.\",\"@type\":\"Answer\"}},{\"name\":\"Who can benefit from Admizz's services?\",\"@type\":\"Question\",\"acceptedAnswer\":{\"text\":\"Both international students seeking to study abroad and recruitment partners, such as education consultants, can benefit from Admizz's services.\",\"@type\":\"Answer\"}}]}</script>" }} />{/* SEOAI:FAQ:END */}
</main>
  );
}
