    ...
    <section className="py-16 md:py-24" style={{ background: "#FFFFFF" }}>
      <style>{`
        :root {
          ...
          --review-slide-offset: calc(100% + 24px);
        }
        @media (min-width: 768px) {
          :root {
            --review-card-width: calc(33.333% - 16px);
            --review-slide-offset: calc(33.333% + 8px);
          }
        }
        .review-card {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Google Summary Bar */}
        <div
          className="flex items-center justify-center gap-3 sm:gap-5 md:gap-7 mb-14 mx-auto px-4 sm:px-8 py-5 rounded-2xl max-w-xl"
          style={{
            background: "#FFFFFF",
        ...
        >
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[13px] font-medium" style={{ color: "#9ca3af" }}>out of 5</p>
            </div>
          </div>
        ...
        <div className="flex items-center gap-5 md:gap-7">
          ...
          <div className="flex-1 min-w-0 overflow-hidden" {...swipeHandlers}>
            <div
              ...
              style={{ transform: `translateX(calc(-${startIndex} * var(--review-slide-offset)))` }}
            >
              {reviews.map((review) => (
                <div
                  key={review.name}
                  className="review-card flex-shrink-0 rounded-2xl bg-white flex flex-col overflow-hidden"
                  style={{
                ...
                >
                  ...
                  {/* Reviewer footer */}
                  <div
                    className="flex items-center gap-3 px-5 sm:px-7 py-5"
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[13px] font-medium truncate" style={{ color: "#6b7280" }}>
                        {review.university}
                      </p>
                      <div className="flex items-center gap-1 mt-0.5">
                        <span className="text-sm leading-none shrink-0">{toEmoji(review.originFlag)}</span>
                        <span className="text-[13px]" style={{ color: "#9ca3af" }}>{review.route}</span>
                        <span className="text-sm leading-none shrink-0">{toEmoji(review.destFlag)}</span>
                      </div>
                    </div>
                  </div>
                </div>
