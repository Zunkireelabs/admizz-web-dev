...
const openPositions = [
  ...
  },
  {
    ...
    requirements: [
      ...
      "Comfortable with CRM and data entry tools",
    ],
    screeningQuestions: [
      {
        id: "experience",
      ...
      {
        id: "call-volume",
        question: "Are you comfortable making 50+ calls per day?",
        type: "radio" as const,
        options: ["Yes", "No"],
        required: true,
      },
  ...
  },
  {
    ...
    requirements: [
      ...
      "Fluency in Nepali and English",
      "Basic computer skills (MS Office, scheduling tools)",
    ],
    screeningQuestions: [
      {
        id: "experience",
      ...
      {
        id: "multitasking",
        question: "Are you comfortable with front-desk and multitasking work?",
        type: "radio" as const,
        options: ["Yes", "No"],
        required: true,
      },
  ...
  },
  {
    ...
    openings: 2,
    description:
      "Verify, compile, and manage student application documents to ensure accuracy and compliance for university and visa submissions.",
    responsibilities: [
      "Review and verify student documents (transcripts, certificates, financial papers) for completeness",
    ...
    requirements: [
      ...
      "Minimum 1 year of experience in documentation, admin, or admissions support",
      "Strong attention to detail and organizational skills",
      "Fluency in English and Nepali",
      "Familiarity with visa/university document requirements is a plus",
    ],
    screeningQuestions: [
      {
        id: "experience",
      ...
      {
        id: "docs-familiarity",
        question: "Are you familiar with visa/university documentation requirements?",
        type: "radio" as const,
        options: ["Yes", "No"],
        required: true,
      },
...
{/* SEOAI:EXPANDEDCONTENT:START */}<div suppressHydrationWarning dangerouslySetInnerHTML={{ __html: "<div class=\"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-[80vh] space-y-0\">\n  <section class=\"gap-2.5\">\n    <h2 class=\"text-[28px] sm:text-4xl md:text-[48px] font-bold leading-tight uppercase\">Admizz Education vs. Competitors for Career Opportunities</h2>\n    <div class=\"text-sm md:text-base mb-3 opacity-90\"><p class=\"text-sm md:text-base mb-3 opacity-90\">When considering a career with Admizz Education, it's essential to understand how it stands out compared to other organizations in the educational consultancy field. Admizz offers unique benefits and a dynamic work environment that may not be present at other companies in the industry.</p><div class=\"overflow-x-auto\"><table class=\"w-full border-collapse\"><thead><tr><th class=\"text-left px-4 py-3 text-sm font-semibold text-navy border border-[#ddd]\">Feature</th><th class=\"text-left px-4 py-3 text-sm font-semibold text-navy border border-[#ddd]\">Alternative</th><th class=\"text-left px-4 py-3 text-sm font-semibold text-navy border border-[#ddd]\">This Option</th></tr></thead><tbody><tr><td class=\"px-4 py-3 text-sm text-navy font-medium border border-[#ddd]\">Global Exposure</td><td class=\"px-4 py-3 text-sm text-navy font-medium border border-[#ddd]\">Limited geographic reach, primarily focusing on regional markets.</td><td class=\"px-4 py-3 text-sm text-navy font-medium border border-[#ddd]\">Work with students and universities across 12+ countries</td></tr><tr><td class=\"px-4 py-3 text-sm text-navy font-medium border border-[#ddd]\">Learning &amp; Growth</td><td class=\"px-4 py-3 text-sm text-navy font-medium border border-[#ddd]\">Generic training programs without specific growth tracks.</td><td class=\"px-4 py-3 text-sm text-navy font-medium border border-[#ddd]\">Regular training, mentorship, and clear career advancement paths</td></tr><tr><td class=\"px-4 py-3 text-sm text-navy font-medium border border-[#ddd]\">Team Culture</td><td class=\"px-4 py-3 text-sm text-navy font-medium border border-[#ddd]\">More hierarchical structure, less emphasis on employee input.</td><td class=\"px-4 py-3 text-sm text-navy font-medium border border-[#ddd]\">Collaborative and supportive environment</td></tr><tr><td class=\"px-4 py-3 text-sm text-navy font-medium border border-[#ddd]\">Competitive Pay</td><td class=\"px-4 py-3 text-sm text-navy font-medium border border-[#ddd]\">Base salary only, rarely reviewed or adjusted.</td><td class=\"px-4 py-3 text-sm text-navy font-medium border border-[#ddd]\">Fair compensation with performance bonuses and salary reviews</td></tr></tbody></table></div></div>\n  </section>\n</div>" }} />{/* SEOAI:EXPANDEDCONTENT:END */}
</main>
  );
}
